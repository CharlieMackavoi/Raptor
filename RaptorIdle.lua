-- Raptor Idle Behavior
--------------------------------------------------------------------------
local Behavior = CreateAIBehavior("RaptorIdle", -- "ParentBehavior",
{
  -- Optional - indicates the alert status (0 = idle, 1 = alert, 2 = engaged in combat)
	...
	Constructor = function (self, entity, data)
		...
		entity:SelectPipe(0, "raptor_random_1");
		--entity:SelectPipe(0, "raptor_standup");
	end,
	...
	OnInterestingSoundHeard = function(self, entity)
		...
		--Log(entity:GetName() .. " - I heard you.");
